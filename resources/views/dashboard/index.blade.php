                                ...
                                <div class="card-body p-24">
                                    ...
                                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 bg-neutral-200 px-8 py-8 radius-4 mb-16">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                                            <img src="{{ asset('assets/images/currency/crypto-img1.png') }}" alt="" class="w-36-px h-36-px rounded-circle flex-shrink-0">
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 bg-neutral-200 px-8 py-8 radius-4 mb-16">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                                            <img src="{{ asset('assets/images/currency/crypto-img2.png') }}" alt="" class="w-36-px h-36-px rounded-circle flex-shrink-0">
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 bg-neutral-200 px-8 py-8 radius-4 mb-16">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                                            <img src="{{ asset('assets/images/currency/crypto-img3.png') }}" alt="" class="w-36-px h-36-px rounded-circle flex-shrink-0">
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 bg-neutral-200 px-8 py-8 radius-4 mb-16">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                                            <img src="{{ asset('assets/images/currency/crypto-img4.png') }}" alt="" class="w-36-px h-36-px rounded-circle flex-shrink-0">
                                            <div class="flex-grow-1">
                                    ...
                                    <div class="d-flex flex-wrap align-items-center justify-content-between gap-2 bg-neutral-200 px-8 py-8 radius-4 mb-16">
                                        <div class="d-flex flex-wrap align-items-center justify-content-between gap-2">
                                            <img src="{{ asset('assets/images/currency/crypto-img5.png') }}" alt="" class="w-36-px h-36-px rounded-circle flex-shrink-0">
                                            <div class="flex-grow-1">
                                    ...
                                    <div>
                                        <div class="card-slider">
                                            <div class="p-20 h-240-px radius-8 overflow-hidden position-relative z-1">
                                                <img src="{{ asset('assets/images/card/card-bg.png') }}" alt="" class="position-absolute start-0 top-0 w-100 h-100 object-fit-cover z-n1">
                        ...
                        <div class="col-xxl-12 col-lg-6">
                            <div class="card h-100">
                                <div class="card-body p-24">
                                    ...
                                    <h6 class="mb-4">
                                        {{ number_format($totalBalance, 2) }} {{ $balances[0]['token_symbol'] ?? '' }}
                                    </h6>
                                    ...
                                    <div class="tab-content" id="pills-tabContent">
                                        <div class="tab-pane fade show active" id="pills-Buy" role="tabpanel" aria-labelledby="pills-Buy-tab" tabindex="0">
                                            ...
                                            <div class="mb-24">
                                                <span class="mb-4 text-sm text-secondary-light">Total Balance</span>
                                                <h6 class="mb-4 fw-semibold text-xl text-warning-main">
                                                    {{ number_format($totalBalance, 2) }} {{ $balances[0]['token_symbol'] ?? '' }}
                                                </h6>
                                            </div>
